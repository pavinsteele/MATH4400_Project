...
#smote                                    
X_sm,Y_sm = SMOTE().fit_resample(X_sc,Y)
#train test split
(X_train_sm, X_test_sm ,Y_train_sm ,Y_test_sm) = \
                                    skm.train_test_split(X_sm,
                                    Y_sm,stratify=Y_sm, test_size=0.2, random_state=0)
#
...
cm_lda = confusion_matrix(Y_test_sm, y_pred_lda)
...
print('Accuracy is {:.5}'.format(accuracy_score(Y_test_sm, y_pred_lda)))
print('F1 Score is {:.5}'.format(f1_score(Y_test_sm, y_pred_lda)))
print('Precission Score is {:.5}'.format(precision_score(Y_test_sm, y_pred_lda)))
...
cm_qda = confusion_matrix(Y_test_sm, y_pred_qda)
plt.figure(figsize=(8, 6))
sns.set(font_scale=1.2)
...
print('Accuracy is {:.5}'.format(accuracy_score(Y_test_sm, y_pred_qda)))
print('F1 Score is {:.5}'.format(f1_score(Y_test_sm, y_pred_qda)))
print('Precission Score is {:.5}'.format(precision_score(Y_test_sm, y_pred_qda)))
...
cm_NB = confusion_matrix(Y_test_sm, y_pred_NB)
plt.figure(figsize=(8, 6))
sns.set(font_scale=1.2)
...
print('Accuracy is {:.5}'.format(accuracy_score(Y_test_sm, y_pred_NB)))
print('F1 Score is {:.5}'.format(f1_score(Y_test_sm, y_pred_NB)))
print('Precission Score is {:.5}'.format(precision_score(Y_test_sm, y_pred_NB)))
...
y_pred_lr =lr_gen.predict(X_test_sm)


cm_lr = confusion_matrix(Y_test_sm, y_pred_lr)
plt.figure(figsize=(8, 6))
sns.set(font_scale=1.2)
...
print('Accuracy is {:.5}'.format(accuracy_score(Y_test_sm, y_pred_lr)))
print('F1 Score is {:.5}'.format(f1_score(Y_test_sm, y_pred_lr)))
print('Precission Score is {:.5}'.format(precision_score(Y_test_sm, y_pred_lr)))
