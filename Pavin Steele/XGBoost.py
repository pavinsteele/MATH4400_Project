...
from sklearn.metrics import accuracy_score, balanced_accuracy_score, precision_score, recall_score, f1_score, confusion_matrix, precision_recall_curve, ConfusionMatrixDisplay
...
cmd = ConfusionMatrixDisplay(cm, display_labels=['Rejected', 'Accepted'])
cmd.plot()
cmd.ax_.set(xlabel='Predicted', ylabel='True')
plt.show()

print('Balance Accuracy is {:.5}'.format(balanced_accuracy_score(Y_test, y_pred_test)))
print('Accuracy is {:.5}'.format(accuracy_score(Y_test, y_pred_test)))
print('F1 Score is {:.5}'.format(f1_score(Y_test, y_pred_test)))
print('Precission Score is {:.5}'.format(precision_score(Y_test, y_pred_test)))
print('Recall Score is {:.5}'.format(recall_score(Y_test, y_pred_test)))
